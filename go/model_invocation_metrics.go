...
type InvocationMetrics struct {
	// Número de chamadas no dia atual.
	CurrentDay int32 `json:"currentDay"`
	// Número de chamadas nos dias anteriores. O primeiro item do array é referente ao dia anterior ao corrente, e assim por diante. Devem ser retornados no máximo sete dias caso estejam disponíveis.​
