...
type PeakTpsMetrics struct {
	// Pico de chamadas por segundo no dia.
	CurrentDay int32 `json:"currentDay"`
	// Pico de chamadas por segundo nos dias anteriores. O primeiro item do array é referente ao dia anterior ao corrente, e assim por diante. Devem ser retornados no máximo sete dias caso estejam disponíveis.
